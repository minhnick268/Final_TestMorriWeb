...
WebUI.setText(findTestObject('Dangky/Page_ng k ti khon/input_a ch Email_Email'), 'morritestgmail.com')
...
WebUI.setText(findTestObject('Dangky/Page_ng k ti khon/input_Nhp li mt khu_ConfirmPassword'), '123456')

WebUI.scrollToPosition(0, 750)

WebUI.waitForElementClickable(findTestObject('Dangky/Page_Trang ch/Page_ng k ti khon/button_ng k'), 0)
