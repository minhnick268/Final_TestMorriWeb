...
WebUI.setText(findTestObject('Dangky/Page_ng k ti khon/input_Mt khu_Password'), '1234')

WebUI.setText(findTestObject('Dangky/Page_ng k ti khon/input_Nhp li mt khu_ConfirmPassword'), '1234')
